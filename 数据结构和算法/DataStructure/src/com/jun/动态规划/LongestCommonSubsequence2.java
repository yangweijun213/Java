...
public class LongestCommonSubsequence2 {
	...
	public static void main(String[] args) {
		String str1 = "cnblogs";
		String str2 = "belong";
		System.out.println(compute(str1, str2));
	}

	/*
	 * 动态规划 - 求最长公共子序列
	 * http://www.hankcs.com/program/algorithm/implementation-and-application-of
	 * -nlp-longest-common-subsequence-longest-common-subsequence-of-java.html
	 */
