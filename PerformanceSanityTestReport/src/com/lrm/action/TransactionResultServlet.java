...
import com.lrm.factory.Factory2;
import com.lrm.vo.TransactionResult;

/**
 * Servlet implementation class demoServlet
 */
public class TransactionResultServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * Default constructor. 
     */
    public TransactionResultServlet() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<TransactionResult> allList = new LinkedList<TransactionResult>();//返回结果集
		...
		allList = Factory2.getTransactionResultDAOInstance().doSearch(keys);
		...
		for (j=m; j<allList.size()&&j<n; j++) {	
				...
				System.out.println(JSONObject.fromObject(allList.get(j)));
		}
